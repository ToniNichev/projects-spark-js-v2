...
var requestDataFromAPI = /*#__PURE__*/function () {
  var _ref = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee(req, res, devicesData, usersData, next) {
    var pathname, parsedQs, validDataObj, hubId, deviceFromDB, templateName;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          /*
          ...
          */
          ...
          parsedQs = querystring.parse(req.parsedUrl.query);
          if (!(pathname === '/setup')) {
            _context.next = 8;
            break;
          }
        ...
        case 8:
          ...
          return _context.abrupt("return");
        case 14:
          validDataObj = stringToObject(parsedQs.data); // device(s) ids
        ...
        case 26:
          deviceFromDB = _context.sent;
          devicesData[hubId] = deviceFromDB;
        case 28:
          // send devices data for this specific hub from the request
          req.apiData = {
            "hubId": hubId,
            "devicesData": devicesData[hubId]
          };
          templateName = typeof _src_containers_PageLayout_PageData__WEBPACK_IMPORTED_MODULE_2__["default"][pathname] != 'undefined' ? _src_containers_PageLayout_PageData__WEBPACK_IMPORTED_MODULE_2__["default"][pathname].template : '';
  ...
  return function requestDataFromAPI(_x, _x2, _x3, _x4, _x5) {
    return _ref.apply(this, arguments);
  };
}();
...
function responseWithSourceCode(req, res, apiData, templateName) {
  ...
  var Html = _src_templates_TemplateList__WEBPACK_IMPORTED_MODULE_12__["default"][templateName];
